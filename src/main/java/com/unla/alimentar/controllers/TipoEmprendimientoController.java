...
import com.unla.alimentar.services.TipoEmprendimientoService;
...
public class TipoEmprendimientoController {
	...
	@ApiResponses(value = { @ApiResponse(code = 201, message = "TipoEmprendimiento eliminado con exito"),
			@ApiResponse(code = 404, message = "TipoEmprendimiento no encontrado") })
	public void eliminarTipoEmprendimiento(@PathVariable("idTipoEmprendimiento") long id ) {
	...
	public ResponseEntity<TipoEmprendimiento> updateAbility(@PathVariable("idTipoEmprendimiento") Long id, TipoEmprendimientoVo tipoEmprendimientoVo) {
