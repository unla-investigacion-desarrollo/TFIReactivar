...
import com.unla.alimentar.services.CategoriaService;
...
public class CategoriaController {
	...
	public ResponseEntity<Categoria> updateAbility(@PathVariable("idCategoria") Long id, CategoriaVo categoriaVo) {
