...
import com.unla.alimentar.services.LocalidadService;
...
public class LocalidadController {
	...
	public ResponseEntity<Localidad> updateAbility(@PathVariable("idLocalidad") Long id, LocalidadVo localidadVo) {
