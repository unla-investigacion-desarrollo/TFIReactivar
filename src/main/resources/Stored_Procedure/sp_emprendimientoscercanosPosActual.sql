CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_emprendimientosCercanosPosActual`(IN id_rubro bigint(20),IN latActual varchar(255), IN longActual varchar(255), IN cantidadKm varchar(255))
BEGIN
  ...
  DECLARE CONTINUE HANDLER FOR NOT FOUND SET fin=1;
    ...
    where (e.id_rubro=id_rubro or 0=id_rubro) and id_estado_emprendimiento=2;
    ...
    /*Setear lat1, long1 de la posición Actual*/
    SET lat1 = latActual;
    SET long1 = longActual;
